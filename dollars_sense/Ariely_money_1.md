...
비교의 대상이 없을 때 쉽게 불확실성이 발생한다. 이 물건의 가치는 얼마나 될까? 비교는 물건의 가치는 파악하는 효과적인 지름길이다. 이것과 비교하기 위해서는 저것이 필요하다. 그리고 저것은 이것의 가치 판단에 영향을 끼치게 된다. 이때 이것의 원래 고유한 가치는 무엇일까? 고유한 가치는 없을 수도 있지만, 이콘이라면 하지 않았던 일관되지 않은 행동이 발생하기도 한다. 애리얼리는 저것, 즉 이것의 가치 판단에 영향을 주는 대상을 통칭해 가치 암시(value que)라고 표현했다.[^1] 우리도 이 표현을 쓰기도 하자. 어찌보면, 행동경제학의 중요한 부분은 이 가치신호가 이콘을 어떻게 교란하는지에 관한 우화의 집합이다. 

[^1]: 번역서에는 "가치 단서"라고 번역했다. que는 방송에서 큐 시트라고 말할 때 들어봤을 말이다. 장면이나 행위를 구분하기 위해 카메라에 불이 들어오는 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU0MDYzNTA0OSwtOTY5NDQ0MTUyLDIyMD
M5MzA2OSwtMTA5OTkyNzM4OCwxMjM4NDc2NTk3LC05MzY0NjQ1
MDFdfQ==
-->