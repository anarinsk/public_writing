...
이 두 진술은 같은 진술인가? 아니다! 심지어 2는 무죄추정의 원칙이라는 법률 원리에 정면으로 위배된다. 그런데 사실 법정에서는 2를 1처럼 쓰는 경우가 비일비재하다. 이는 이른바 베이즈 정리와 관련된 내용인데, 다소 복잡하니 일단 넘어가도록 하자. 안타깝게도 미국 법정에서조차 베이즈 정리에 입각한 증거 평가는 공식적으로 받아들여지지 않고 있다.[^2]

[^2]: 자세한 내용은 [이곳](https://www.sciencenews.org/blog/context/courts%E2%80%99-use-statistics-should-be-put-trial)을 참고하라. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg2OTg5ODAzMSwtNDY4ODUxNDczXX0=
-->