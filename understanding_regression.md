...
여기서 회귀분석을 해설할 생각은 없다. 이미 너무나 많은 그리고 매우 훌륭한 내용들이 책, 웹, 강의로 넘쳐날테니까. 이 글의 용도는 그림 하나로 놓치기 쉬운 회귀분석의 핵심을 한 눈에 보는 것이다. 나는 [crossvalidated](https://stats.stackexchange.com/questions/123651/geometric-interpretation-of-multiple-correlation-coefficient-r-and-coefficient)에서 이 그림을 보는 순간 일종의 '돈오돈수'가 찾아 왔다. 이렇게 이해하면 쉬웠을 것을... 일단 우리에게 익숙한 회귀분석 식을 매트릭스로 적어보자. 
...
위 그림은 보통 2차원 평면으로 예시되는 아래 그림과는 다르다. 
...
Jun Sok Huhh | :house:[lostineconomics.com](http://lostineconomics.com)
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyNDk4MTIzOF19
-->