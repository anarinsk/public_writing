...
이제 아나콘다를 쓰기로 했다고 치자. 아나콘다도 두 가지로 배포판이 제공한다. 종합 배포판인 아나콘다 대신 핵심 만을 발라낸 Miniconda가 좋다. 미니콘다가 왜 좋을까? 보통 아나콘다를 풀 버전을 깔면 쓸 데 없는 것들이 같이 깔린다. 일종의 합집합 개념의 패키지를 제공하는데, 이걸로 길을 들여 놓으면 이후에 곤란한 경우가 처할 수도 있다. 하드 디스크의 용량이 부족한 시대는 아니지만, 잘 쓰지 않는 것을 갖고 있을 필요도 없지 않을까. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzA1NDE2ODMwLC0xNzk4MDY4MTE2XX0=
-->